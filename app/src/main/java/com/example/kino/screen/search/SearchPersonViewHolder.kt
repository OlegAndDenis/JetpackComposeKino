...
//
//class SearchPersonViewHolder private constructor(itemView: View) :
...
//            LinearLayoutManager(context, RecyclerView.HORIZONTAL, false).also {
...
//        oldItems: List<NetworkItem>,
//        nextItems: List<NetworkItem>
//    ) {
